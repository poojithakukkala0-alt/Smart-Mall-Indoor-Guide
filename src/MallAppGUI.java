...
public class MallAppGUI {
    ...
    private void buildGUI(List<Location> locationList, Map<String, String> stores, StringBuilder locText) {
        ...
        searchPanel.setBorder(BorderFactory.createTitledBorder(
                new LineBorder(new Color(200, 0, 150), 2, true), "Search Store", TitledBorder.CENTER, TitledBorder.TOP,
                new Font("Segoe UI", Font.BOLD, 18), new Color(120, 0, 150)
        ));

        GridBagConstraints sGbc = new GridBagConstraints();
        sGbc.insets = new Insets(4, 100, 5, 100);
        ...
        routePanel.setBackground(new Color(230, 255, 250));
        routePanel.setBorder(BorderFactory.createTitledBorder(
                new LineBorder(new Color(0, 120, 180), 2, true), "Find Route", TitledBorder.CENTER, TitledBorder.TOP,
        ...
        locPanel.setBackground(new Color(255, 250, 235));
        locPanel.setBorder(BorderFactory.createTitledBorder(
                new LineBorder(new Color(200, 150, 80), 2, true), "All Locations", TitledBorder.CENTER, TitledBorder.TOP,
